"""lazy_stars_21561 URL Configuration
...
admin.site.site_header = "Lazy Stars"
admin.site.site_title = "Lazy Stars Admin Portal"
admin.site.index_title = "Lazy Stars Admin"

# swagger
api_info = openapi.Info(
    title="Lazy Stars API",
    default_version="v1",
    description="API documentation for Lazy Stars App",
)
